...
#ifdef CONFIG_MFD_RT5033_RESET_WA
#if defined(CONFIG_SEC_A3_PROJECT) || defined(CONFIG_SEC_A3_EUR_PROJECT)
		if (system_rev > 5 && !strncmp(cam_vreg->reg_name, "cam_vana", 8)){
#elif  defined(CONFIG_SEC_A33G_EUR_PROJECT )			
		if (system_rev >= 3 && !strncmp(cam_vreg->reg_name, "cam_vana", 8)){
#endif
